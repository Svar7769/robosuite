...
all_positions = []
desired_length = 1000  # Fix number of points for each trajectory

# Iterate over each demo and extract trajectories
for demo_idx in range(num_demos):
    ...
    # Interpolate trajectory to a fixed length (desired_length)
    interp_func = interp1d(timesteps, ee_positions, axis=0,
